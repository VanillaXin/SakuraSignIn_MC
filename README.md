...
2. **签到奖励配置**：
    ...
    - 参数解读：
      ...
      - `dateTimeRewards`：指定日期/日期范围签到奖励，可以指定日期或日期范围，签到该日期/日期范围，会获得相应的奖励。
        例如：按照示例配置，在每年的10月06日~10月07日签到，会获得1个经验瓶子及持续5分钟的抗性Ⅱ效果。指定日期/ 日期范围签到奖励，日期格式支持 yyyy-MM-dd, 0000-MM-dd, yyyy-MM-00, 0000-MM-00, yyyy~n-MM~n-dd, 0000-MM~n-dd~n, yyyy-MM~n-00, 0000-MM~n-00, yyyy-MM-ddTHH:mm, yyyy-MM-ddTHH~n:mm~n。
