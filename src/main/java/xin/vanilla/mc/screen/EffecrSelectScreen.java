...
public class EffecrSelectScreen extends Screen {
    ...
    private void updateLayout() {
        ...
        this.OP_BUTTONS.put(OperationButtonType.EFFECT.getCode(), new OperationButton(OperationButtonType.EFFECT.getCode(), context -> {
            ...
            // 绘制效果详情悬浮窗
            if (context.button.isHovered()) {
                AbstractGuiUtils.drawPopupMessage(AbstractGuiUtils.componentToText(this.currentEffect.getEffect().getDisplayName().copy()), (int) context.mouseX, (int) context.mouseY, this.width, this.height);
            }
