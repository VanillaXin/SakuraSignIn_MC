...
public class ModNetworkHandler {
    ...
    public static void registerPackets() {
        ...
        INSTANCE.messageBuilder(SignInDataSyncPacket.class, nextID()).encoder(SignInDataSyncPacket::toBytes).decoder(SignInDataSyncPacket::new).consumerMainThread(SignInDataSyncPacket::handle).add();
